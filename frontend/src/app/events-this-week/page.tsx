      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        {weeklyEvents.length > 0 ? (
          ...
          <div className="border border-dashed border-gray-300 rounded-lg py-16 px-6 text-center">
            <h2 className="text-xl font-semibold text-gray-900 mb-2">No events scheduled this week</h2>
            <p className="text-gray-600">Check back soon for new campus events.</p>
          </div>
        )}
      </main>
    </div>
